...
[`@aws-sdk/client-medialive`](https://www.npmjs.com/package/@aws-sdk/client-medialive/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pBln4pcVO0HYaiC11nqQmnbxxf6LNd4N6HlazZhywe3/SVPhCOcSpCcYeAzv8RZl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-medialive": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.131.0/index.min.mjs": "sha384-pBln4pcVO0HYaiC11nqQmnbxxf6LNd4N6HlazZhywe3/SVPhCOcSpCcYeAzv8RZl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-medialive/blob/refs/tags/3.131.0/LICENSE
```
