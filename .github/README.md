...
[`@aws-sdk/client-medialive`](https://www.npmjs.com/package/@aws-sdk/client-medialive/v/3.10.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.10.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xmtjhpGl06NAYWUkHiO73Dd/V+CP7V0klcoQwSMku7Wn61icuH1vclicfRIFjL/g
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-medialive": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.10.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.10.0/index.min.mjs": "sha384-xmtjhpGl06NAYWUkHiO73Dd/V+CP7V0klcoQwSMku7Wn61icuH1vclicfRIFjL/g"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-medialive/blob/refs/tags/3.10.0/LICENSE
```
