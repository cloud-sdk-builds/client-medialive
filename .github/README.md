...
[`@aws-sdk/client-medialive`](https://www.npmjs.com/package/@aws-sdk/client-medialive/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rSlxVuxJdayDphkqQ+gnnNFMdeeCX4UA9WctKdb9E6EcZtFqGZB1Pp6m1u2gdtEp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-medialive": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.25.0/index.min.mjs": "sha384-rSlxVuxJdayDphkqQ+gnnNFMdeeCX4UA9WctKdb9E6EcZtFqGZB1Pp6m1u2gdtEp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-medialive/blob/refs/tags/3.25.0/LICENSE
```
