...
[`@aws-sdk/client-medialive`](https://www.npmjs.com/package/@aws-sdk/client-medialive/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JsasXTmu2Wezd0a/r5vw2XUzBY+vDCI9np3j60jh6veMK5cSVccMQmxciRTVB55o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-medialive": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-medialive@3.454.0/index.min.mjs": "sha384-JsasXTmu2Wezd0a/r5vw2XUzBY+vDCI9np3j60jh6veMK5cSVccMQmxciRTVB55o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-medialive/blob/refs/tags/3.454.0/LICENSE
```
